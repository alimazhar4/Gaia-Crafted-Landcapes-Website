...
const ReviewsSection = () => {
	return (
		<section className="py-24 md:py-32 bg-plum-dark">
			<div className="max-w-[1400px] mx-auto px-8 md:px-16">
				...
				<div className="mb-16 md:mb-20">
					...
					<h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.1] tracking-tight text-white">
				...
				{/* Row 1 */}
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 md:gap-5 mb-4 md:mb-5">
					{/* Stat Block - Rating */}
					<div className="lg:col-span-3 bg-plum rounded-2xl p-6 md:p-8 flex flex-col justify-between h-[260px] border-2 border-white/40">
						<div className="flex flex-col gap-3">
							<div className="flex -space-x-2">
								{[1, 2, 3, 4].map((i) => (
									<div
										key={i}
										className="w-9 h-9 rounded-full bg-sage/30 border-2 border-plum flex items-center justify-center">
						...
						<div>
							<p className="font-display text-4xl md:text-5xl font-semibold text-gold mb-1">
								5.0 / 5.0
							</p>
					...
					<div className="lg:col-span-4 bg-white rounded-2xl p-6 md:p-8 flex flex-col justify-between h-[260px] border-2 border-white/40">
						<div>
							...
							<p className="text-plum/80 leading-relaxed text-sm">
								&quot;{reviews[0].quote}&quot;
							</p>
						</div>
					...
					{/* Image Block 1 */}
					<div className="relative lg:col-span-5 rounded-2xl overflow-hidden h-[260px]">
						<Image
							src={reviewGarden1}
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 md:gap-5 mb-4 md:mb-5">
					{/* Image Block 2 */}
					<div className="relative lg:col-span-4 rounded-2xl overflow-hidden h-[240px]">
						<Image
							src={reviewGarden2}
					...
					{/* Review 2 - Sage */}
					<div className="lg:col-span-4 bg-sage-light rounded-2xl p-6 flex flex-col justify-between h-[240px] border-2 border-white/40">
						<div>
							<div className="flex gap-0.5 mb-3">
								{[1, 2, 3, 4, 5].map((i) => (
									<Star key={i} className="w-3.5 h-3.5 fill-gold text-gold" />
						...
						<div className="flex items-center justify-between">
							...
							<Quote className="w-6 h-6 text-plum/30" />
						</div>
					</div>

					{/* Review - Robert */}
					<div className="lg:col-span-4 bg-white rounded-2xl p-6 flex flex-col justify-between h-[240px] border-2 border-white/40">
						<div>
							<div className="flex gap-0.5 mb-3">
								{[1, 2, 3, 4, 5].map((i) => (
									<Star key={i} className="w-3.5 h-3.5 fill-gold text-gold" />
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 md:gap-5">
					...
					<div className="lg:col-span-3 bg-sage-light rounded-2xl p-6 flex flex-col justify-between h-[220px] border-2 border-white/40">
						<div>
							<div className="flex gap-0.5 mb-3">
								{[1, 2, 3, 4, 5].map((i) => (
									<Star key={i} className="w-3.5 h-3.5 fill-gold text-gold" />
					...
					<div className="lg:col-span-4 bg-charcoal rounded-2xl p-6 flex flex-col justify-between h-[220px] border-2 border-white/40">
						<div>
							<div className="flex gap-0.5 mb-3">
								{[1, 2, 3, 4, 5].map((i) => (
									<Star key={i} className="w-3.5 h-3.5 fill-gold text-gold" />
					...
					{/* Image Block 3 */}
					<div className="relative lg:col-span-3 rounded-2xl overflow-hidden h-[220px]">
						<Image
							src={reviewGarden3}
							alt="Elegant pergola"
							fill
					...
					{/* Stat Block - Gardens */}
					<div className="lg:col-span-2 bg-plum rounded-2xl p-6 flex flex-col justify-between h-[220px] border-2 border-white/40">
